...
class MySubscriptionScreenState extends State<MySubscriptionScreen> {
                              ...
                              Align(
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                        fontSize: 10, color: AppColors.primary_color),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: Container(
                                                child: Text(
                                                  "Offer Name : "+snapshot.data.data[index]
                                                      .plan_name,
                                                  style: TextStyle(
                                                      fontSize: 14.0,
                                                      color: AppColors
                                            ...
                                            Container(
                                                margin: EdgeInsets.only(
                                                    ...
                                                    right: 15),
                                                child: Text(
                                                      "Service Name : "+snapshot.data.data[index]
                                                          .service_name,
                                                  style: TextStyle(
                                                      fontSize: 12.0,
                                                      color: AppColors
                                            ...
                                            Container(
                                                margin: EdgeInsets.only(
                                                    ...
                                                    right: 15),
                                                child: Text(
                                                      "Rs. "+snapshot.data.data[index].amount,
                                                  style: TextStyle(
                                                      color: AppColors
                                                          .white,
                                                      fontSize: 12),
                                            ...
                                            Container(
                                                ...
                                                bottom: 10),
                                                child: Text(
                                                      "Expire on : "+snapshot.data.data[index].subscribe_end_date,
                                                  style: TextStyle(
                                                      color: AppColors
                                                          .white,
                                                      fontSize: 12),
  ...
  Future<Subscriptions> getData() async {
    ...
    final response = await http
        .post(KApiBase.BASE_URL + KApiEndPoints.MySubscriptionPlan, body: body);
